...
[v_part, f_part, n_part, stltitle_part] = stlRead('Fan blade_Base.STL');
...
hold on;
[v_tool, f_tool, n_tool, stltitle_tool] = stlRead('tool.STL');
...
for i = 1:size(l1,1)-1
    ...
    plot3(l1_new(:,1),l1_new(:,2),l1_new(:,3),'k');
    hold on;
    hold on;
    [v_tool, f_tool, n_tool, stltitle_tool] = stlRead('tool.STL');
